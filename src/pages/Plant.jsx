  ...
  const devices = [
    {
      id: "all",
      name: "All Devices",
      power: currentPlant.currentPower,
      energy: currentPlant.todayEnergy,
      status: "active",
    },
    {
      id: "inv1",
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <div className="h-48 rounded-lg overflow-hidden">
                <iframe
                  ...
                  )}&key=AIzaSyCnnZFd3rhI1s55YWfZxngj0qbo5URO36Q`}
